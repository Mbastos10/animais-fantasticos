...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initAccordion)\n/* harmony export */ });\nfunction initAccordion() {\n  var accordionList = document.querySelectorAll('[data-anime=\"accordion\"] dt'); // VARIÁVEL PRA NÃO REPETIR A STRING 'ATIVO' TODA HORA\n\n  var activeClass = \"ativo\";\n\n  function activeAccordion() {\n    // ADICIONAR ATIVO AO DD\n    this.classList.toggle(activeClass); // ADICIONAR ATIVO AO ELEMENTO APÓS O DT - USAR nextElementSibling\n\n    this.nextElementSibling.classList.toggle(activeClass);\n  }\n\n  if (accordionList.length) {\n    accordionList[0].classList.add(activeClass);\n    accordionList[0].nextElementSibling.classList.add(activeClass);\n    accordionList.forEach(function (item) {\n      item.addEventListener(\"click\", activeAccordion);\n    });\n  }\n}\n\n//# sourceURL=webpack://animais/./js/modules/accordion.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ initScroll)\n/* harmony export */ });\n// SMOOTH SCROLL\nfunction initScroll() {\n  // SELECIONAR LINKS INTERNOS HREF COMEÇA COM \"#\"\n  var linksInternos = document.querySelectorAll('[data-menu=\"suave\"] a[href^=\"#\"]'); // FUNÇÃO SCROLL\n\n  function scrollToSection(event) {\n    // PREVINE SCROLL PADRÃO AO CLICAR\n    event.preventDefault(); // PEGAR O ATRIBUTO HREF NO CLIQUE\n\n    var href = event.currentTarget.getAttribute(\"href\"); // LINKAR O HREF DO CLICK COM A SEÇÃO COM O MESMO ID\n\n    var section = document.querySelector(href); // JEITO FÁCIL DE SMOOTH SCROLL\n\n    section.scrollIntoView({\n      behavior: \"smooth\",\n      block: \"start\"\n    }); // FORMA ALTERNATIVA DE SMOOTH SCROLL\n    // const topo = section.offsetTop;\n    // window.scrollTo({\n    //     top: topo,\n    //     behavior: 'smooth',\n    // });\n  }\n\n  linksInternos.forEach(function (link) {\n    link.addEventListener(\"click\", scrollToSection);\n  });\n}\n\n//# sourceURL=webpack://animais/./js/modules/scroll-suave.js?");
